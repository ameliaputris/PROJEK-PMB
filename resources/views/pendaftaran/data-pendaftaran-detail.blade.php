        ...
        <div class="col-xl-12">
            <div class="custom-accordion">
                ...
                <div class="alert alert-success alert-dismissible fade show">
                    ...
                    <strong>Selamat!</strong> Data pendaftaranmu sudah terkirim kedalam sistem. Sebelum melakukan pembayaran, tunggu administrator memverifikasi datamu ya.
                ...
                <div class="alert alert-info alert-dismissible fade show">
                    ...
                    <strong>Informasi!</strong> Segera lakukan pembayaran ke VA:9882 2081 2196.
                    <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="btn-close">
                    </button>
                </div>
                @endif
