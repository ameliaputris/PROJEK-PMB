                    ...
                    <div class="p-4">
                        <div class="d-flex">
                            <div class="col-lg-3" style="text-align: center; margin-right:25px; margin-left:25px;">
                                <img width="110px" src="{{ asset('sipenmaru/images/logoibik.png') }}" alt="">
                            </div>
                            <div class="col-lg-6">
                                <center>
                                    <label class="form-label" style="margin-top: -0.5rem"><strong class="d-block">KARTU TES
                                            PESERTA</strong></label>
                                    <h5 style="margin-top: -0.5rem"> <strong class="d-block">PENERIMAAN MAHASISWA BARU</strong></h4>
                                        <h4 style="margin-top: -0.5rem"><strong class="d-block">INSTITUT BISNIS DAN INFORMATIKA KESATUAN</strong></h3>
                                            <p style="margin-top: -0.5rem"><strong class="d-block">Jl. Rangga Gading No.01, Gudang, Kecamatan Bogor Tengah, Kota Bogor, Jawa Barat <br> 16123</strong></p>
                                </center>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="p-4" style="border-top: 2px solid black!important; margin-top:-2.5rem;">
                            <div class="d-flex">
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-3 mb-4">
                                        ...
                                        <h5 style="text-indent: 0.5in"><strong>{{ $viewData->nik }}</strong></h5>
                                        <strong>NAMA LENGKAP</strong><br>
                                        <h5 style="text-indent: 0.5in"><strong>{{ $viewData->nama_siswa }}</strong></h5>
                                        <strong>TANGGAL LAHIR</strong><br>
                                        <h5 style="text-indent: 0.5in"><strong>{{ $viewData->tanggal_lahir }}</strong></h5>
                                        <strong>JENIS KELAMIN</strong><br>
                                        <h5 style="text-indent: 0.5in"><strong>{{ $viewData->jenis_kelamin}}</strong></h5>
                                        <strong>ALAMAT</strong><br>
                                        <h5 style="text-indent: 0.5in"><strong>{{ $viewData->alamat}}</strong></h5>
                                        <strong>EMAIL</strong><br>
                                        <h5 style="text-indent: 0.5in"><strong>{{ $viewData->email}}</strong></h5>
                                        <strong>NO HANDPHONE</strong><br>
                                        <h5 style="text-indent: 0.5in"><strong>{{ $viewData->hp}}</strong></h5>
                            ...
                            <div class="mb-4">
                                ...
                                <h5 style="text-indent: 0.5in;text-align: justify;">Saya yang menyatakan bahwa data yang
                                    saya isikan dalam formulir pendaftaran penerimaan mahasiswa baru Institut Bisnis dan Informatika
                                    Kesatuan Tahun Ajaran 2024/2025 adalah benar dan saya bersedia menerima ketentuan yang berlaku.</h5>
                            </div>
                        </div>
                    </div>
                </div>
