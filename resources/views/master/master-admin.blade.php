        ...
        ***********************************-->
        <div class="nav-header">
            <a href="dashboard" class="brand-logo">
                <img alt="image" width="25" src="{{ asset('sipenmaru/images/logoibik.png') }}">
                <div class="brand-title">
                    <h2 class="">PMB IBIK</h2>
                </div>
            </a>
        ...
        <div class="footer">
            <div class="copyright">
                <p>Copyright ©
                    ...
                    Designed &amp; Developed by <a href="https://www.instagram.com/ameliaptriis/" target="_blank">Amelia Putri Sulaeman
                    </a>
                </p>
            </div>
        </div>
