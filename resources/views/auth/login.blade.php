...
<head>
    ...
    <meta name="description" content="PMB IBIK">
    <meta property="og:title" content="PMB IBIK">
    <meta property="og:description" content="PMB IBIK">

    <!-- PAGE TITLE HERE -->
    <title>Masuk dan Daftar | PMB IBIK</title>
    ...
    <div class="container">
        <div class="forms-container">
            <div class="signin-signup">
                ...
                <div class="social-media">
                    <a href="https://web.facebook.com/ibikesatuan" class="social-icon">
                        <i class="fab fa-facebook-f"></i>
                    </a>
                    <a href="https://www.instagram.com/ibikesatuan?igsh=MTJwbGxtdWpmbHFuNQ==" class="social-icon">
                        <i class="fab fa-instagram"></i>
                    </a>
                    <a href="https://x.com/ibikesatuan?s=20" class="social-icon">
                        <i class="fab fa-twitter"></i>
                    </a>
                    <a href="https://www.ibik.ac.id/" class="social-icon">
        ...
        <div class="panels-container">
            <div class="panel left-panel">
                <div class="content">
                    <h3>Ayo Daftar di Institut Bisnis dan Informatika Kesatuan!</h3>
                    <p>
                        IBI Kesatuan merupakan salah satu perguruan tinggi di kota Bogor yang berkuliatas dan unggul di 
                        bidang nya dengan memiliki program studi Magister akuntansi,  Sarjana Strata 1 dan Sarjana Terapan.
                    </p>
            ...
            <div class="panel right-panel">
                <div class="content">
                    <h3>Berminat menjadi bagian dari IBI Kesatuan?</h3>
                    <p>
